...
begin
    ...
    while stop <> 1 do
        ...
        # we does not count the last month, which we dont know for sure whether this guy has quitted
        while DATE_ADD(v_temp_date, INTERVAL 30 DAY) < v_last_active_date do
            ...
            insert into v_user_monthly_post_count_pt1 (user_id,month,post_count) values (v_user_id,v_month,v_month_post_count);
